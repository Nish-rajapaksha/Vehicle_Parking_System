...
public class DataBase {
    ...
    public static ArrayList<ParkVehicle> vehiclePark = new ArrayList<ParkVehicle>();
    public static ArrayList<DeliveryVehicle> vehicleDelivery = new ArrayList<DeliveryVehicle>();

    public static ArrayList<Slot> slotTable = new ArrayList<>();


    static {
        slotTable.add(new Slot("01","Van","notused"));
        slotTable.add(new Slot("02","Van","notused"));
        slotTable.add(new Slot("03","Van","notused"));
        slotTable.add(new Slot("04","Van","notused"));
        slotTable.add(new Slot("05","Cargo Lorry","notused"));
        slotTable.add(new Slot("06","Cargo Lorry","notused"));
        slotTable.add(new Slot("07","Cargo Lorry","notused"));
        slotTable.add(new Slot("08","Cargo Lorry","notused"));
        slotTable.add(new Slot("09","Cargo Lorry","notused"));
        slotTable.add(new Slot("10","Cargo Lorry","notused"));
        slotTable.add(new Slot("11","Cargo Lorry","notused"));
        slotTable.add(new Slot("12","Van","notused"));
        slotTable.add(new Slot("13","Van","notused"));
        slotTable.add(new Slot("14","Bus","notused"));
